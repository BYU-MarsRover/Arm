...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("590dfba5-0f20-4007-a5c7-dafc1b63a1a5"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
