...
#define Channel_1_DM_ALG_HIZ         (0x00u << Channel_1_DRIVE_MODE_SHIFT)
#define Channel_1_DM_DIG_HIZ         (0x01u << Channel_1_DRIVE_MODE_SHIFT)
#define Channel_1_DM_RES_UP          (0x02u << Channel_1_DRIVE_MODE_SHIFT)
#define Channel_1_DM_RES_DWN         (0x03u << Channel_1_DRIVE_MODE_SHIFT)
#define Channel_1_DM_OD_LO           (0x04u << Channel_1_DRIVE_MODE_SHIFT)
#define Channel_1_DM_OD_HI           (0x05u << Channel_1_DRIVE_MODE_SHIFT)
#define Channel_1_DM_STRONG          (0x06u << Channel_1_DRIVE_MODE_SHIFT)
#define Channel_1_DM_RES_UPDWN       (0x07u << Channel_1_DRIVE_MODE_SHIFT)
