...
module top ;
	...
	wire [0:0] tmpOE__motor_driver_net;
	wire [0:0] tmpFB_0__motor_driver_net;
	wire [0:0] tmpIO_0__motor_driver_net;
	wire [0:0] tmpINTERRUPT_0__motor_driver_net;
	electrical [0:0] tmpSIOVREF__motor_driver_net;

	cy_psoc3_pins_v1_10
		#(.id("0be85069-2057-4b0f-b70d-4bbafe8e8ff0"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		motor_driver
		 (.oe(tmpOE__motor_driver_net),
		  .y({Net_486}),
		  .fb({tmpFB_0__motor_driver_net[0:0]}),
		  .io({tmpIO_0__motor_driver_net[0:0]}),
		  .siovref(tmpSIOVREF__motor_driver_net),
		  .interrupt({tmpINTERRUPT_0__motor_driver_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__motor_driver_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
